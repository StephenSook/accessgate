...
export default defineConfig({
  ...
  server: {
    proxy: {
      ...
      '/check-captions':{ target: API_URL, changeOrigin: true },
      '/gaps':          { target: API_URL, changeOrigin: true },
      '/fix':           { target: API_URL, changeOrigin: true },
      '/demo-fix':      { target: API_URL, changeOrigin: true },
      '/demo-summary':  { target: API_URL, changeOrigin: true },
      '/demo':          { target: API_URL, changeOrigin: true },
      '/summary':       { target: API_URL, changeOrigin: true },
      '/report':        { target: API_URL, changeOrigin: true },
      '/judges':        { target: API_URL, changeOrigin: true },
